 ...
 * [FormDinasFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FormDinasFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FormDinasFragment : FormSubmissionFragment() {
    override val title: String = "Pengajuan Dinas"

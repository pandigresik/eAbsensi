...
class SakitFragment : SubmissionFragment() {

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        addFormButton.setOnClickListener {
                view -> view.findNavController().navigate(R.id.action_sakitFragment_to_formSakitFragment)
        }
    }
    override fun setAdapterFragment(): SubmissionPagerAdapter {
        return SakitPagerAdapter(context!!,childFragmentManager)
    }
}
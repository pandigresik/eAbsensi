 ...
 * [FormSakitFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FormSakitFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class FormSakitFragment : FormSubmissionFragment() {
    override val title: String = "Pengajuan Sakit"

 ...
 */
class CutiHolderFragment : SubmissionHolderFragment() {
    ...
    companion object {
         ...
         */
        @JvmStatic
        fun newInstance(sectionNumber: Int): CutiHolderFragment {
            return CutiHolderFragment().apply {
